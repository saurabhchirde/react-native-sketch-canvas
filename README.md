...
A React Native component for drawing by touching on both iOS and Android. <br/>
**(This is a revised and maintained copy of [Library](https://github.com/terrylinla/react-native-sketch-canvas) after fixing known issues and errors.)**
...
```bash
npm install @csaurabh/react-native-sketch-canvas --save
```

Link native code

```bash
react-native link @csaurabh/react-native-sketch-canvas
```
